...
from .hubert_model import HubertConfig, HubertModel,HubertPretrainingConfig
...
@dataclass
class ImlsHubertConfig(HubertConfig):
...
class ImlsHubertModel(HubertModel):
    def __init__(
        self,
        cfg: ImlsHubertConfig,
    ...
    @classmethod
    def build_model(cls, cfg: ImlsHubertConfig, task):
        """Build a new model instance."""

        model = ImlsHubertModel(cfg, task.cfg, task.dictionaries)
        return model
